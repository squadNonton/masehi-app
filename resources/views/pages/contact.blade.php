                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control rounded-3" id="nama" name="nama" placeholder="Nama Lengkap" value="{{ old('nama') }}" required>
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control rounded-3" id="subjek" name="subjek" placeholder="Subjek" value="{{ old('subjek') }}" required>
                                    <label for="subjek">Subjek</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control rounded-3" placeholder="Pesan Anda" id="pesan" name="pesan" style="height: 150px" required>{{ old('pesan') }}</textarea>

        ...
        <form action="{{ route('admin.galeri.update', $galeri) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="album" class="form-control" value="{{ old('album', $galeri->album) }}">
                </div>
                <div class="col-md-12 mb-3">
                    <label class="form-label">Deskripsi</label>
                    <textarea name="deskripsi" class="form-control" rows="3">{{ old('deskripsi', $galeri->deskripsi) }}</textarea>
                </div>
                <div class="col-md-6 mb-3" id="foto-input" style="{{ $galeri->tipe == 'video' ? 'display:none' : '' }}">
                    <label class="form-label">File Foto</label>
                    @if($galeri->file_path)
                    <div class="mb-2">
                        <img src="{{ asset('img/galeri/' . $galeri->file_path) }}" alt="{{ $galeri->judul }}" class="img-thumbnail" style="max-width: 200px;">
                    </div>
                    @endif
                ...
                <div class="col-md-6 mb-3" id="video-input" style="{{ $galeri->tipe == 'foto' ? 'display:none' : '' }}">
                    <label class="form-label">URL Video (YouTube)</label>
                    <input type="url" name="video_url" class="form-control @error('video_url') is-invalid @enderror" value="{{ old('video_url', $galeri->video_url) }}">
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-check mt-4">
                        <input type="checkbox" name="is_active" class="form-check-input" id="is_active" {{ $galeri->is_active ? 'checked' : '' }}>
